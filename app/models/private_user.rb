...
class PrivateUser < ActiveRecord::Base
  ...
  scope :sorted, order("private_users.last_name ASC, private_users.first_name ASC")
  ...
  def self.authenticate(username="",password="")
    user = PrivateUser.find_by_username(username)
  ...
  def password_match?(password="")
    hashed_password == PrivateUser.hash_with_salt(password,salt)
  end
